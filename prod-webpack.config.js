...
module.exports = require('./MapStore2/build/buildConfig')(
    {
        'devhome': path.join(__dirname, "js", "app"),
        'devhome-embedded': path.join(__dirname, "js", "embedded"),
        'devhome-api': path.join(__dirname, "MapStore2", "web", "client", "product", "api"),
